      ...
      <div className="flex flex-col items-center justify-center min-h-screen px-4 pt-20">
        <div className="w-full max-w-md glass rounded-[2rem] p-8 mt-12 border border-white/10 shadow-[0_0_40px_rgba(0,0,0,0.6)] animate-in fade-in zoom-in-95 duration-500 relative overflow-hidden group">
          ...
          <div className="flex justify-center mb-6">
            <div className="w-12 h-12 rounded-xl bg-primary flex items-center justify-center shadow-[0_0_20px_rgba(255,215,0,0.5)]">
              <Zap className="text-black w-6 h-6 fill-black" />
            </div>
          </div>
          
          <h1 className="text-3xl font-extrabold text-center mb-2 tracking-tight">Welcome Back</h1>
          <p className="text-white/50 text-center text-sm mb-8">Sign in to participate in the Live Sansad consensus</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full bg-black/50 border border-white/10 rounded-xl px-4 py-3 text-white placeholder-white/30 focus:outline-none focus:border-primary/50 focus:ring-1 focus:ring-primary/50 transition-all font-medium"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full mt-6 bg-gradient-to-r from-primary to-yellow-600 hover:from-white hover:to-white text-black font-black uppercase tracking-widest py-3.5 rounded-xl transition-all shadow-[0_0_20px_rgba(255,215,0,0.2)] hover:shadow-[0_0_20px_rgba(255,255,255,0.4)] disabled:opacity-50 disabled:cursor-not-allowed flex justify-center items-center gap-2"
            >
